        ...
        <div class="card-body">
          ...
          if (isset($_POST['submit'])) {
            ...
            if ($img != "" && $title != "" && $description != "" && $top_title != "" && $top_desc != "") {
              $query = "UPDATE about_us SET top_title= '$top_title', top_desc='$top_desc', title='$title', description='$description', img='$img' WHERE id=$id";
          ...
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="selectedImage" name="img" value="<?php echo $data['img']; ?>"> <!-- throw error when value is called-->
              <!-- modal -->
