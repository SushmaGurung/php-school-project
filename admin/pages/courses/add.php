        ...
        <div class="card card-default">
          ...
          if(isset($_POST['submit'])){
            ...
            if($img !="" && $top_title !="" && $top_desc !="" && $c_title !="" && $fee !="" && $description !=""){
                    $query= "INSERT INTO courses ( top_title, top_desc, img, c_title, fee, description) VALUES ('$top_title', '$top_desc','$img','$c_title','$fee','$description')";
          ...
          ?>
           <form method="POST" enctype="multipart/form-data">
             <div class="mb-3">
               ...
               <input type="text" class="form-control" id="exampleInputEmail1" name="top_title" value="" aria-describedby="emailHelp">
             </div>
             <div class="mb-3">
               <label for="exampleInputEmail1" class="form-label">Top Description</label>
               <input type="text" class="form-control" id="exampleInputEmail1" name="top_desc" value="" aria-describedby="emailHelp">
             </div>
             <div class="mb-3">
               <label for="selectedImage" class="form-label">Image</label>
               <input type="text" class="form-control" id="selectedImage" name="img" value="">
                <!-- modal -->
              <?php require("../inc/modal.php"); ?>
             </div>
             <div class="mb-3">
               <label for="exampleInputPassword1" class="form-label">Course Title</label>
               <input type="text" class="form-control" id="exampleInputPassword1" name="c_title" value="">
             </div>
             <div class="mb-3">
               <label for="exampleInputPassword1" class="form-label">Fee</label>
               <input type="text" class="form-control" id="exampleInputPassword1" name="fee" value="">
             </div>
             <div class="mb-3">
