      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          if(isset($_GET['id'])){
            ...
            $sql="SELECT *FROM whychoose_us WHERE id=$id";
          ...
          if(isset($_POST['submit'])){
            ...
            if($title !="" && $description !="" && $btn !=""){
                    $query= "UPDATE whychoose_us SET title='$title', description='$description', btn='$btn' WHERE id=$id";
          ...
          ?>
           <form method="POST" enctype="multipart/form-data">
             ...
             <div class="mb-3">
               ...
               <input type="text" class="form-control" id="exampleInputPassword1" name="btn" value="<?php echo $data['btn']; ?>">
             </div>
