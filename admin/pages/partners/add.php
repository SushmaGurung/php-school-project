      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          if(isset($_POST['submit'])){
            ...
            if($icon !="" && $title !=""){
                    $query= "INSERT INTO partners (icon, title) VALUES ('$icon', '$title')";
          ...
          ?>
           <form method="POST" enctype="multipart/form-data">
             <div class="mb-3">
               ...
               <input type="text" class="form-control" id="exampleInputEmail1" name="icon" placeholder="fa-regular fa-comment" value="" aria-describedby="emailHelp">
             </div>
             <div class="mb-3">
