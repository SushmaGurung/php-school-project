      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          if(isset($_POST['submit'])){
            ...
            if($number !="" && $title !="" ){
                    $query= "UPDATE facts SET number='$number', title='$title' WHERE id=$id";
          ...
          ?>
           <form method="POST" enctype="multipart/form-data">
             <div class="mb-3">
               ...
               <input type="text" class="form-control" id="exampleInputEmail1" name="number" value="<?php echo $data['number']; ?>" aria-describedby="emailHelp">
             </div>
             <div class="mb-3">
