      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          if(isset($_POST['submit'])){
            ...
            if($img !="" && $top_title !="" && $top_desc !="" && $title !="" && $description !=""){
                    $query= "INSERT INTO events ( top_title, top_desc, img, title, description) VALUES ('$top_title', '$top_desc','$img','$title','$description')";
